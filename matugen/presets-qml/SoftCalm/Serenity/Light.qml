...
QtObject {
    ...
    // Secondary
    readonly property color secondary: "#273a9b"
    readonly property color on_secondary: "#ffffff"
    readonly property color secondaryContainer: "#d0d5f1"
    readonly property color on_secondary_container: "#0a1447"

    // Tertiary
    readonly property color tertiary: "#279b74"
    readonly property color on_tertiary: "#ffffff"
    readonly property color tertiaryContainer: "#d0f1e6"
    readonly property color on_tertiary_container: "#0a4733"
