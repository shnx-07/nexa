...
QtObject {
    ...
    // Secondary
    readonly property color secondary: "#8999e6"
    readonly property color on_secondary: "#080f36"
    readonly property color secondaryContainer: "#1f2751"
    readonly property color on_secondary_container: "#afbaf4"

    // Tertiary
    readonly property color tertiary: "#89e6c7"
    readonly property color on_tertiary: "#083626"
    readonly property color tertiaryContainer: "#1f5141"
    readonly property color on_tertiary_container: "#aff4dd"
