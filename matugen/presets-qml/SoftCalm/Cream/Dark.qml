...
QtObject {
    // Primary
    readonly property color primary: "#edc682"
    readonly property color on_primary: "#372506"
    readonly property color primaryContainer: "#54401c"
    readonly property color on_primary_container: "#f6dbac"
    ...
    readonly property color surfaceBright: "#494031"
    ...
    readonly property color surfaceContainerHighest: "#4c4334"

    // Surface content
    readonly property color on_surface: "#e7e2da"
    readonly property color on_surface_variant: "#c2baad"
    readonly property color inverseSurface: "#e5e2dc"
    readonly property color inverse_on_surface: "#252018"
    readonly property color inversePrimary: "#bd8728"

    // Outline and overlays
    readonly property color outline: "#847762"
