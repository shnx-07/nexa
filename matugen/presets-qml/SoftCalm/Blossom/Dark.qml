...
QtObject {
    // Primary
    readonly property color primary: "#ed829d"
    readonly property color on_primary: "#370612"
    readonly property color primaryContainer: "#541c2a"
    readonly property color on_primary_container: "#f6acbf"
    ...
    // Tertiary
    readonly property color tertiary: "#a8e689"
    readonly property color on_tertiary: "#173608"
    readonly property color tertiaryContainer: "#30511f"
    readonly property color on_tertiary_container: "#c6f4af"
