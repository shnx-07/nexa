...
QtObject {
    // Primary
    readonly property color primary: "#1d34a5"
    readonly property color on_primary: "#ffffff"
    readonly property color primaryContainer: "#cdd3f4"
    readonly property color on_primary_container: "#081349"
    ...
    readonly property color on_background: "#171a26"

    // Surface hierarchy
    readonly property color surface: "#f6f7f8"
    readonly property color surfaceDim: "#dadce7"
    ...
    readonly property color surfaceContainerHigh: "#d8dae4"
    readonly property color surfaceContainerHighest: "#cbcedc"

    // Surface content
    readonly property color on_surface: "#171a26"
    readonly property color on_surface_variant: "#45495e"
    readonly property color inverseSurface: "#272935"
    readonly property color inverse_on_surface: "#edeef3"
    readonly property color inversePrimary: "#8f9fef"

    // Outline and overlays
    readonly property color outline: "#7b819d"
    readonly property color outlineVariant: "#c3c6d5"
