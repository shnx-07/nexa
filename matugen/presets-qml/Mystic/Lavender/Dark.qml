...
QtObject {
    ...
    // Tertiary
    readonly property color tertiary: "#8999e6"
    readonly property color on_tertiary: "#080f36"
    readonly property color tertiaryContainer: "#1f2751"
    readonly property color on_tertiary_container: "#afbaf4"
