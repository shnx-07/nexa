...
QtObject {
    ...
    // Tertiary
    readonly property color tertiary: "#89e699"
    readonly property color on_tertiary: "#08360f"
    readonly property color tertiaryContainer: "#1f5127"
    readonly property color on_tertiary_container: "#aff4ba"
