...
QtObject {
    // Primary
    readonly property color primary: "#611da5"
    readonly property color on_primary: "#ffffff"
    readonly property color primaryContainer: "#e0cdf4"
    readonly property color on_primary_container: "#290849"

    // Secondary
    readonly property color secondary: "#9b2774"
    readonly property color on_secondary: "#ffffff"
    readonly property color secondaryContainer: "#f1d0e6"
    readonly property color on_secondary_container: "#470a33"
    ...
    readonly property color on_background: "#1f1726"

    // Surface hierarchy
    readonly property color surface: "#f7f6f8"
    readonly property color surfaceDim: "#e0dae7"
    ...
    readonly property color surfaceContainer: "#e8e4ec"
    readonly property color surfaceContainerHigh: "#ded8e4"
    readonly property color surfaceContainerHighest: "#d4cbdc"

    // Surface content
    readonly property color on_surface: "#1f1726"
    readonly property color on_surface_variant: "#52455e"
    readonly property color inverseSurface: "#2e2735"
    readonly property color inverse_on_surface: "#f0edf3"
    readonly property color inversePrimary: "#bf8fef"

    // Outline and overlays
    readonly property color outline: "#8c7b9d"
    readonly property color outlineVariant: "#ccc3d5"
