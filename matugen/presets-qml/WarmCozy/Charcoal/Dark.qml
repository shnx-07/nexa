...
QtObject {
    // Primary
    readonly property color primary: "#edb882"
    readonly property color on_primary: "#371f06"
    readonly property color primaryContainer: "#54381c"
    readonly property color on_primary_container: "#f6d1ac"
    ...
    // Tertiary
    readonly property color tertiary: "#e69989"
    readonly property color on_tertiary: "#360f08"
    readonly property color tertiaryContainer: "#51271f"
    readonly property color on_tertiary_container: "#f4baaf"
    ...
    readonly property color surfaceBright: "#493d31"
    readonly property color surfaceContainerLowest: "#15120e"
    readonly property color surfaceContainerLow: "#27211c"
    readonly property color surfaceContainer: "#302922"
    readonly property color surfaceContainerHigh: "#3c332a"
    readonly property color surfaceContainerHighest: "#4c4034"

    // Surface content
    readonly property color on_surface: "#e7e0da"
    readonly property color on_surface_variant: "#c2b8ad"
    readonly property color inverseSurface: "#e5e0dc"
    readonly property color inverse_on_surface: "#251f18"
    readonly property color inversePrimary: "#bd7328"

    // Outline and overlays
    readonly property color outline: "#847362"
    readonly property color outlineVariant: "#42382e"
