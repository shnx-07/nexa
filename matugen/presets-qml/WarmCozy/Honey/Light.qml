...
QtObject {
    // Primary
    readonly property color primary: "#a57c1d"
    readonly property color on_primary: "#ffffff"
    readonly property color primaryContainer: "#f4e8cd"
    readonly property color on_primary_container: "#493608"

    // Secondary
    readonly property color secondary: "#9b5d27"
    readonly property color on_secondary: "#ffffff"
    readonly property color secondaryContainer: "#f1dfd0"
    readonly property color on_secondary_container: "#47270a"
    ...
    readonly property color surfaceContainerHigh: "#e4e0d8"
    readonly property color surfaceContainerHighest: "#dcd7cb"

    // Surface content
    readonly property color on_surface: "#262217"
    readonly property color on_surface_variant: "#5e5645"
    readonly property color inverseSurface: "#353127"
    readonly property color inverse_on_surface: "#f3f1ed"
    readonly property color inversePrimary: "#efd28f"

    // Outline and overlays
    readonly property color outline: "#9d937b"
    readonly property color outlineVariant: "#d5d0c3"
