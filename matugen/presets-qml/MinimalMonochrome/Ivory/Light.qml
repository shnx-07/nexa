...
QtObject {
    // Primary
    readonly property color primary: "#a5781d"
    readonly property color on_primary: "#ffffff"
    readonly property color primaryContainer: "#f4e7cd"
    readonly property color on_primary_container: "#493408"
    ...
    readonly property color inversePrimary: "#efcf8f"

    // Outline and overlays
    readonly property color outline: "#9d927b"
    readonly property color outlineVariant: "#d5cfc3"
