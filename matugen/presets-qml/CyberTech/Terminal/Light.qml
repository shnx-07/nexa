...
QtObject {
    // Primary
    readonly property color primary: "#1da528"
    readonly property color on_primary: "#ffffff"
    readonly property color primaryContainer: "#cdf4d0"
    readonly property color on_primary_container: "#08490e"
    ...
    // Tertiary
    readonly property color tertiary: "#6b9b27"
    readonly property color on_tertiary: "#ffffff"
    readonly property color tertiaryContainer: "#e3f1d0"
    readonly property color on_tertiary_container: "#2e470a"

    // Background
    readonly property color background: "#f6f8f6"
    readonly property color on_background: "#172618"

    // Surface hierarchy
    readonly property color surface: "#f6f8f6"
    readonly property color surfaceDim: "#dae7db"
    readonly property color surfaceBright: "#fcfdfc"
    readonly property color surfaceContainerLowest: "#ffffff"
    readonly property color surfaceContainerLow: "#edf2ee"
    readonly property color surfaceContainer: "#e4ece5"
    readonly property color surfaceContainerHigh: "#d8e4d9"
    readonly property color surfaceContainerHighest: "#cbdccd"

    // Surface content
    readonly property color on_surface: "#172618"
    readonly property color on_surface_variant: "#455e47"
    readonly property color inverseSurface: "#273528"
    readonly property color inverse_on_surface: "#edf3ed"
    readonly property color inversePrimary: "#8fef97"

    // Outline and overlays
    readonly property color outline: "#7b9d7e"
    readonly property color outlineVariant: "#c3d5c4"
