...
QtObject {
    ...
    // Secondary
    readonly property color secondary: "#e689cf"
    readonly property color on_secondary: "#36082a"
    readonly property color secondaryContainer: "#511f45"
    readonly property color on_secondary_container: "#f4afe2"
