...
QtObject {
    ...
    // Secondary
    readonly property color secondary: "#e6d789"
    readonly property color on_secondary: "#362e08"
    readonly property color secondaryContainer: "#51491f"
    readonly property color on_secondary_container: "#f4e8af"
