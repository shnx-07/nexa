...
QtObject {
    ...
    // Secondary
    readonly property color secondary: "#e689b8"
    readonly property color on_secondary: "#36081f"
    readonly property color secondaryContainer: "#511f38"
    readonly property color on_secondary_container: "#f4afd1"
